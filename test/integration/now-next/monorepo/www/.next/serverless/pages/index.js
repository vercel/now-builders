module.exports = (function(modules) {
  ...
  return __webpack_require__((__webpack_require__.s = 'mZBx'));
})({
...
*/ var getOwnPropertySymbols =
  ...
  mZBx: function(module, __webpack_exports__, __webpack_require__) {
    'use strict';
    __webpack_require__.r(__webpack_exports__);
    ...
    var _document_default = __webpack_require__.n(_document);
    var _error = __webpack_require__('/a9y');
    var _error_default = __webpack_require__.n(_error);
    var _app = __webpack_require__('B5Ud');
    var _app_default = __webpack_require__.n(_app);
    var hello = __webpack_require__('wZ9u');
    var hello_default = __webpack_require__.n(hello);
    var pages = function() {
      return ''.concat(hello_default()(), ' Welcome to the index page');
    };
    __webpack_require__.d(__webpack_exports__, 'render', function() {
      return next_serverless_loaderpage_2F_absolutePagePath_private_next_pages_2Findex_js_absoluteAppPath_next_2Fdist_2Fpages_2F_app_absoluteDocumentPath_next_2Fdist_2Fpages_2F_document_absoluteErrorPath_next_2Fdist_2Fpages_2F_error_distDir_private_dot_next_buildId_bNfhCZ8Og_GG0uMv9Vw7X_assetPrefix_generateEtags_true_render;
    });
    async function renderReqToHTML(req, res) {
      ...
      try {
        const result = await Object(render['renderToHTML'])(
          ...
          '/',
          parsedUrl.query,
          Object.assign({}, options, { Component: pages })
        );
        return result;
      } catch (err) {
        if (err.code === 'ENOENT') {
          ...
          const result = await Object(render['renderToHTML'])(
            ...
            '/_error',
            parsedUrl.query,
            Object.assign({}, options, { Component: _error_default.a })
          );
          return result;
        } else {
          console.error(err);
    ...
    async function next_serverless_loaderpage_2F_absolutePagePath_private_next_pages_2Findex_js_absoluteAppPath_next_2Fdist_2Fpages_2F_app_absoluteDocumentPath_next_2Fdist_2Fpages_2F_document_absoluteErrorPath_next_2Fdist_2Fpages_2F_error_distDir_private_dot_next_buildId_bNfhCZ8Og_GG0uMv9Vw7X_assetPrefix_generateEtags_true_render(
      req,
      res
    ) {
      try {
